...
const AboutMe = () => {
  return (
    <section
      className="relative content-grid w-full bg-gray-700 pt-15 lg:pt-30 pb-10 lg:pb-20"
      id="about-me"
    >
      {/* Header Image. */}
      <div className="content-main grid grid-rows-[auto_auto] place-items-center lg:grid-cols-2 gap-y-8 gap-x-40">
        <div className="grid items-center place-items-center">
          <HeadSvg className="z-10 size-60 lg:size-140 row-start-1 col-start-1" />
          <div className="bg-white size-50 lg:size-120 rounded-full row-start-1 col-start-1 drop-shadow-2xl" />
        </div>

        {/* About me text. */}
        <div className="flex flex-col gap-10 items-center lg:ml-10">
          <div className="relative border-8 border-white h-fit">
            <h2 className="uppercase text-white text-3xl lg:text-4xl font-bold absolute left-0 right-0 lg:right-auto mx-auto w-fit -top-5 lg:left-8 bg-gray-700 px-4">
              About me
            </h2>
            <ul className="text-2xl lg:text-3xl text-center lg:text-left pt-8 pb-6 px-8 flex flex-col gap-4">
              <p>
